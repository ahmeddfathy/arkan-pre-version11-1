    ...
    if (projectCtx) {
        new Chart(projectCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        window.performanceData.projectStats.new,
                        window.performanceData.projectStats.in_progress,
                        window.performanceData.projectCompletionPoints,
                        window.performanceData.projectStats.cancelled
                    ],
                    backgroundColor: [
                        colors.new,
                        colors.progress,
