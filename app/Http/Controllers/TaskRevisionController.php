...
class TaskRevisionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'project_id' => 'required_if:revision_type,project|integer|min:1',
            'service_id' => 'nullable|integer|exists:company_services,id',
            'assigned_to' => 'nullable|integer|exists:users,id',
            'responsible_user_id' => 'required_if:revision_type,project|integer|exists:users,id',
            'executor_user_id' => 'required_if:revision_type,project|integer|exists:users,id',
        ...
        $messages = [
            ...
            'project_id.required_if' => 'المشروع مطلوب عند إضافة تعديل مشروع',
            'responsible_user_id.required_if' => 'المسؤول مطلوب عند إضافة تعديل مشروع',
            'responsible_user_id.integer' => 'معرف المسؤول يجب أن يكون رقم',
            'responsible_user_id.exists' => 'المسؤول المحدد غير موجود',
            'executor_user_id.required_if' => 'المنفذ مطلوب عند إضافة تعديل مشروع',
