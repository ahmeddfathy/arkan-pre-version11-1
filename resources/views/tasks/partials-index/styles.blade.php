...
#projectCodeFilter, #create_project_code {
...
#projectCodeFilter::placeholder, #create_project_code::placeholder {
...
#projectCodeFilter:focus, #create_project_code:focus {
    border-color: #1e40af;
...
#projectCodesList option, #createProjectCodesList option {
    font-family: 'Courier New', monospace;
    font-size: 14px;
    font-weight: 600;
    padding: 8px 12px;
...
/* زر المسح */
#clearProjectCode, #clear_create_project_code {
    border-color: #3b82f6;
    color: #3b82f6;
    transition: all 0.3s ease;
}

#clearProjectCode:hover, #clear_create_project_code:hover {
    background-color: #3b82f6;
    color: white;
}

/* تحسين input-group */
.input-group #projectCodeFilter, .input-group #create_project_code {
    border-right: none;
}

.input-group #clearProjectCode, .input-group #clear_create_project_code {
