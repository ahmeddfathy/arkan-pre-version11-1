        ...
        <div class="col-lg-9">
            @if($selectedEmployeeId)
                <div class="card">
                    ...
                    <div class="card-body">
                        @if(count($taskData) > 0 || ($timeLogsData && count($timeLogsData['logs']) > 0) || ($revisionsData && count($revisionsData['revisions']) > 0))
                            <!-- Time Logs Timeline -->
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <!-- Real-Time Timeline -->
                                            @if($shiftData && isset($shiftData['timeline']) && count($shiftData['timeline']) > 0)
                                            <div class="mt-4">
                                                ...
                                                <div class="real-time-timeline-container" style="background: #f8f9fa; border-radius: 12px; padding: 20px; overflow-x: auto;">
                                                    ...
                                                    <div class="hour-row mb-4" style="border-bottom: 2px solid #dee2e6; padding-bottom: 15px;">
                                                        ...
                                                        <div class="minutes-row" style="display: flex; gap: 3px; flex-wrap: wrap; padding: 10px; background: #fff; border-radius: 8px; border: 1px solid #e9ecef; position: relative;">
                                                            ...
                                                            @if($selectedDate->isToday() && $shiftData)
                                                                @php
                            ...
                            <div class="card">
                                <div class="card-body text-center p-5">
                                    ...
                                    @else
                                        ...
                                        <p class="text-muted mb-4">
                                            لم يتم العثور على أي مهام، جلسات عمل، أو تعديلات للموظف المحدد في هذا التاريخ
                                        </p>
...
<script>
    ...
    window.employeeReportConfig = {
        ...
        isToday: {{ $selectedDate && $selectedDate->isToday() ? 'true' : 'false' }},
        hasActiveSessions: {{ ($timeLogsData && count($timeLogsData['active_sessions']) > 0) ? 'true' : 'false' }},
        activeSessionsCount: {{ ($timeLogsData && count($timeLogsData['active_sessions']) > 0) ? count($timeLogsData['active_sessions']) : '0' }},
        ...
        shiftData: {
            ...
            breakStart: '{{ $shiftData['break_start'] }}',
            breakEnd: '{{ $shiftData['break_end'] }}',
            ...
            hasBreak: {{ $shiftData['has_break'] ? 'true' : 'false' }}
        }
        @endif
    };
</script>
