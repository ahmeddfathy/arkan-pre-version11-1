                    ...
                    <form method="POST" action="{{ route('seasons.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                @enderror
                                <small class="form-text text-muted">مثال: سيزون الإنجاز 2024، سيزون التميز، إلخ.</small>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input id="color_theme" type="color" class="form-control @error('color_theme') is-invalid @enderror" name="color_theme" value="{{ old('color_theme', '#007bff') }}">
                                </div>
                                @error('color_theme')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                @enderror
                                <small class="form-text text-muted">صورة أيقونة السيزون (اختياري). الحجم المثالي: 200×200 بكسل.</small>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                @enderror
                                <small class="form-text text-muted">صورة غلاف السيزون (اختياري). الحجم المثالي: 1200×300 بكسل.</small>
                                <img id="bannerPreview" class="image-preview" src="#" alt="معاينة الغلاف">
                            </div>
                        </div>
