        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-3xl font-bold text-gray-900">تعديل الشارة: {{ $badge->name }}</h2>
                        <p class="mt-1 text-sm text-gray-600">تعديل معلومات الشارة</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   id="required_points"
                                   value="{{ old('required_points', $badge->required_points) }}"
                                   min="0"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                                   placeholder="100"
                                   required>
                        ...
                        <div>
                            ...
                            <input type="color"
                                   name="color_code"
                                   id="color_code"
                                   value="{{ old('color_code', $badge->color_code ?? '#6B7280') }}"
                        ...
                        @if($badge->icon)
                            <div class="md:col-span-2">
                                ...
                                <div class="flex items-center space-x-4 space-x-reverse">
                                    ...
                                    <span class="text-sm text-gray-600">أيقونة الشارة الحالية</span>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="md:col-span-2">
                            <label for="icon" class="block text-sm font-medium text-gray-700 mb-2">
                                {{ $badge->icon ? 'تغيير أيقونة الشارة' : 'أيقونة الشارة' }}
                            </label>
                            <input type="file"
                                   name="icon"
                                   id="icon"
                            ...
                            <p class="mt-1 text-sm text-gray-500">
                                {{ $badge->icon ? 'اختر صورة جديدة للشارة (اختياري)' : 'اختر صورة للشارة' }} (PNG, JPG, GIF, SVG)
                            </p>
                            @error('icon')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
