...
<div class="simple-container">
    <div class="container">
        ...
        <div class="page-header">
            ...
            <p>إنشاء باقة خدمات جديدة في النظام</p>
        </div>
            ...
            <div class="col-lg-10 col-md-12">
                <div class="package-card">
                    <div class="package-card-header">
                        <h2>معلومات الباقة</h2>
                    </div>
                    <div class="package-card-body">
                        <form action="{{ route('packages.store') }}" method="POST" id="package-form">
                            @csrf

                            <div class="form-group">
                                <label>اسم الباقة <span class="text-danger">*</span></label>
                                <input type="text" name="name" class="form-control" required value="{{ old('name') }}" placeholder="أدخل اسم الباقة">
                            </div>

                            <div class="form-group">
                                <label>الوصف</label>
                                <textarea name="description" class="form-control" rows="4" placeholder="وصف تفصيلي للباقة...">{{ old('description') }}</textarea>
                            </div>
                                ...
                                @if(count($services) > 0)
                                    <div class="services-grid">
                                        @foreach($services as $service)
                                            <div class="service-checkbox-item" onclick="toggleCheckbox({{ $service->id }})">
                            ...
                            <div style="margin-top: 2rem; display: flex; gap: 1rem; flex-wrap: wrap;">
                                <button type="submit" class="packages-btn">
