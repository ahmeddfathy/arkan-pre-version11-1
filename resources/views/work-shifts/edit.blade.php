                        ...
                        <div class="card-body">
                            <form action="{{ route('work-shifts.update', $workShift) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="break_start_time" class="form-control" type="time" name="break_start_time" value="{{ old('break_start_time', $workShift->break_start_time ? $workShift->break_start_time->format('H:i') : '') }}" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="break_end_time" class="form-control" type="time" name="break_end_time" value="{{ old('break_end_time', $workShift->break_end_time ? $workShift->break_end_time->format('H:i') : '') }}" />
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="break_duration_minutes" class="form-control" type="number" name="break_duration_minutes" value="{{ old('break_duration_minutes', $workShift->break_duration_minutes) }}" min="0" />
